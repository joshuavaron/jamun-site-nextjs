...
// The rounded-full pill button used for CTAs across the design.
// Three sizes (sm/md/lg) and four built-in tones. Use `tone="custom"` with a
// `color` prop to render in a per-feature color (the program grid uses this to
// color each card's "Learn More" pill).
...
const toneStyles: Record<Exclude<Tone, "custom">, string> = {
  primary: "bg-[#397bce] text-white hover:bg-[#2a5fa3]",
  outline:
