...
// Format icons
function getFormatIcon(format: MathletesResourceFormat) {
  switch (format) {
    case "Video":
      return Video;
    case "PDF":
...
// Format colors
function getFormatColor(format: MathletesResourceFormat) {
  switch (format) {
    case "Video":
...
export default function MathletesResourcesPageContent({
  ...
  const [selectedCategories, setSelectedCategories] = useState<
    Set<MathletesResourceCategory>
  >(new Set());
  const [selectedFormats, setSelectedFormats] = useState<Set<MathletesResourceFormat>>(
    new Set()
  );
  const [searchQuery, setSearchQuery] = useState("");

  // Toggle functions for multi-select
  const toggleCategory = (category: MathletesResourceCategory) => {
  ...
  const toggleFormat = (format: MathletesResourceFormat) => {
  ...
  // Format options
  const allFormatOptions: { name: MathletesResourceFormat; count: number }[] = [
    {
      name: "Article" as MathletesResourceFormat,
      count: resources.filter((r) => r.format === "Article").length,
    },
    {
      name: "PDF" as MathletesResourceFormat,
  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-50/50 via-white to-teal-50 min-h-[calc(100vh-3.5rem)] md:min-h-[calc(100vh-4rem)] flex items-center py-16 md:py-20 lg:py-24">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-teal-100/20 to-emerald-100/20 rounded-full blur-3xl -z-10" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Everything you need to prepare for Mathletes success. From
                beginner problem-solving guides to advanced competition strategies,
                find resources tailored to your skill level.
              </motion.p>
              ...
              <div className="space-y-6">
                ...
                {resources.length === 0 && (
                  <div className="text-center py-8">
                    <Calculator className="w-12 h-12 text-emerald-300 mx-auto mb-4" />
                    <p className="text-gray-600">
                      Mathletes resources are coming soon! Check back after our Fall 2026 launch.
                    </p>
                  </div>
                )}
              </div>
      ...
      <Section background="gray" className="py-16 md:py-20">
        <SectionHeader
          ...
          subtitle="Browse our collection of guides, problem sets, and tutorials designed to help you succeed in Mathletes."
        />
        ...
        {resources.length === 0 ? (
          ...
          >
            ...
            <p className="text-gray-600 mb-8 max-w-md mx-auto">
              We&apos;re building our Mathletes resource library for our Fall 2026 launch.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button href="/mathletes" variant="outline">
                Back to Mathletes
              </Button>
            </div>
          </motion.div>
            ...
            {filteredResources.map((resource) => {
              ...
              return (
                <motion.div key={resource.slug} variants={itemVariants}>
                  <Link href={`/mathletes/resources/${resource.slug}`}>
                    <motion.div
                      whileHover={{ y: -4 }}
      ...
      <Section background="white" className="py-16 md:py-20">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-10 leading-relaxed">
            Join our interest list to be among the first to know when JAMUN Mathletes
            launches. Get early access to resources, practice problems, and registration.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button href="/mathletes" variant="outline" size="lg">
                Learn About Mathletes
              </Button>
            </motion.div>
          </div>
