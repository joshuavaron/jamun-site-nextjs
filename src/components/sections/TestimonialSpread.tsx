...
// The "themed proof spreads" on the landing page (blue / purple / emerald)
// all share this shape: a serif H3 lead-in, a blockquote, and a small
// attribution. Inputs are content-only — the layout, clip-free photo, and
// scroll animation are handled inside.
...
interface TestimonialSpreadProps {
  ...
  quote: ReactNode;
  /** Attribution line (e.g. "— A parent of a JAMUN delegate"). */
