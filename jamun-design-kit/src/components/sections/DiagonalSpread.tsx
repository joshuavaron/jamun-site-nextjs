...
// A full-bleed two-column layout. One column holds a photo, the other holds a
// text panel. The workhorse layout for hero, stats, quote, and final-CTA
  ...
  const panel = (
    <motion.div
      ...
      className={cn(
        ...
        // text inside a full-bleed spread lands on the same rail as text
        // inside a `<Container>` section. Without this scaling the panel's
        // outer text edge drifts past Container's edge once viewport > 1500px.
        // (654px = (1500px max-width / 2) - lg gutter 96px.)
        photoSide === "left"
