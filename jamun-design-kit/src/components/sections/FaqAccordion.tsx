...
// A single-open accordion of question/answer rows. The first row is open by
// default; clicking another opens it and closes the previous. Click an open
// row to close it. Rows are separated by hairline rules and use the blue
// accent on the open state.
