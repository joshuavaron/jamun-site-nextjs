...
/**
 * useBGWriterState - Main state management hook for the BGWriter context
 *
 * Contains all state, effects, refs, and callback handlers.
...
import type { BGWriterContextValue } from "./bgWriterTypes";

export function useBGWriterState(): BGWriterContextValue {
