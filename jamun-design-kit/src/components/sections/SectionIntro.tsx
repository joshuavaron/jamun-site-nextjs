...
// The centered intro block that opens most content sections:
//   serif heading (large) → optional lead paragraph → optional children (CTAs).
// The heading uses the `section` size variant.
